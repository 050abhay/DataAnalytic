...
# Define the content as a list of tuples (cell_type, content)
content = [
    ...
    ("markdown", "### Datetime Conversion:\nConvert a column to datetime."),
    
    ("code", "df['Date'] = pd.to_datetime(df['Date'])"),
    
    ("markdown", "### DateTimeIndex:\nYou can use date/time as an index."),
...
for cell_type, content in content:
...
with open("pandas_tutorial.ipynb", 'w', encoding='utf-8') as f:
    nbf.write(nb, f)
